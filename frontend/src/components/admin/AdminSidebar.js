import { LayoutDashboard, Users, Database, LogOut, ShieldAlert, X } from 'lucide-react';

function AdminSidebar({ active, onNavigate, onLogout, mobileOpen, onCloseMobile }) {
  const navItems = [
    { key: 'dashboard', label: 'Admin Dashboard', icon: LayoutDashboard },
    { key: 'users', label: 'User Management', icon: Users },
    { key: 'all-products', label: 'Global Products', icon: Database }
  ];
